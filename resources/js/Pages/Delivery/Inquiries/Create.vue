...
const submit = () => {
    form.post(route('delivery.inquiries.store'));
};
</script>
    ...
    <DeliveryAuthenticatedLayout>
        <template #header>
            <div class="flex items-center gap-3">
                <Link :href="route('delivery.inquiries.index')" class="text-gray-400 hover:text-gray-600 dark:text-gray-500 dark:hover:text-gray-300 transition-colors">
        ...
        <div class="max-w-2xl mx-auto">
            <div class="bg-white dark:bg-gray-900 rounded-3xl shadow-sm border border-gray-100 dark:border-gray-800 overflow-hidden">
                <!-- Form Header -->
                <div class="bg-gradient-to-r from-orange-50 to-amber-50 dark:from-orange-950/30 dark:to-amber-950/30 px-8 py-6 border-b border-gray-100 dark:border-gray-800">
                    <div class="flex items-center gap-3">
                        <div class="h-10 w-10 bg-orange-100 dark:bg-orange-950/50 rounded-2xl flex items-center justify-center">
                ...
                <form @submit.prevent="submit" class="p-8 space-y-5">
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                        ...
                        <div>
                            ...
                            <input
                                v-model="form.name"
                                type="text"
                                class="w-full rounded-2xl border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/50 px-4 py-3 text-sm font-medium text-gray-800 dark:text-gray-200 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all"
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            rows="5"
                            class="w-full rounded-2xl border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/50 px-4 py-3 text-sm font-medium text-gray-800 dark:text-gray-200 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all resize-none"
                    ...
                    <div class="flex items-center gap-3 pt-2">
                        <button
                            ...
                            class="flex-1 bg-orange-500 hover:bg-orange-600 disabled:opacity-60 text-white font-black py-3 rounded-2xl text-sm uppercase tracking-widest transition-all shadow-md shadow-orange-200 dark:shadow-none"
                        >
                            {{ form.processing ? 'Submitting...' : 'Submit Inquiry' }}
                        </button>
                        <Link
                            :href="route('delivery.inquiries.index')"
