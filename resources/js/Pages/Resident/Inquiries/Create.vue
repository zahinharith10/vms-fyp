...
const submit = () => {
    form.post(route('resident.inquiries.store'));
};
</script>
    ...
    <ResidentAuthenticatedLayout>
        <template #header>
            <div class="flex items-center gap-3">
                <Link :href="route('resident.inquiries.index')" class="text-gray-400 hover:text-gray-600 dark:text-gray-500 dark:hover:text-gray-300 transition-colors">
            ...
            <div class="bg-white dark:bg-gray-900 rounded-3xl shadow-sm border border-gray-100 dark:border-gray-800 overflow-hidden">
                ...
                <form @submit.prevent="submit" class="p-8 space-y-5">
                    ...
                    <div class="flex items-center gap-3 pt-2">
                        ...
                        <Link
                            :href="route('resident.inquiries.index')"
