        ...
        <div class="max-w-3xl mx-auto">
            ...
            <div class="bg-gradient-to-br from-indigo-600 via-indigo-700 to-purple-700 rounded-3xl p-8 mb-6 shadow-lg shadow-indigo-200/40 dark:shadow-indigo-950/30 text-white relative overflow-hidden">
                ...
                <div class="relative z-10">
                    ...
                    <Link
                        :href="route('visitor.inquiries.create')"
                ...
                >
                    <div class="flex items-start justify-between gap-3">
                        <div class="flex-1 min-w-0">
                            ...
                            <!-- Admin Reply -->
                            <div v-if="inquiry.reply" class="mt-4 pl-4 border-l-2 border-indigo-500 space-y-1 bg-indigo-50/30 dark:bg-indigo-950/10 p-3.5 rounded-r-2xl rounded-bl-2xl">
                                <div class="flex items-center gap-1.5 text-[10px] font-black text-indigo-600 dark:text-indigo-400 uppercase tracking-widest">
                                    <span>✉️</span>
