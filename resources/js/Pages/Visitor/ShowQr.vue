...
<template>
    ...
    <VisitorAuthenticatedLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 dark:text-white leading-tight">Visitor QR Code</h2>
        </template>
        ...
        <div class="py-12">
            <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white dark:bg-gray-900 overflow-hidden shadow-sm dark:shadow-indigo-950/10 sm:rounded-lg border border-transparent dark:border-gray-800">
                    <div class="p-6 text-gray-900 dark:text-gray-100 flex flex-col items-center">
                        ...
                        <div v-if="visit.status === 'Checked In'" class="mb-8 w-full max-w-xs">
                            <label class="block text-sm font-black text-gray-700 dark:text-gray-300 uppercase tracking-widest mb-3 text-center">Checkout Intent</label>
                            <div class="flex bg-gray-100 dark:bg-gray-800 p-1 rounded-2xl border border-gray-200 dark:border-gray-700">
                                <button 
                                    ...
                                    :class="checkoutType === 'temp' ? 'bg-white dark:bg-gray-900 text-indigo-600 dark:text-indigo-400 shadow-sm' : 'text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300'"
                                ...
                                <button 
                                    ...
                                    :class="checkoutType === 'final' ? 'bg-white dark:bg-gray-900 text-indigo-600 dark:text-indigo-400 shadow-sm' : 'text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300'"
                                    class="flex-1 py-3 px-4 rounded-xl text-xs font-black uppercase transition-all"
                                >
                                    🏁 Final
                                </button>
                            </div>
                            <p class="text-[10px] text-center mt-2 font-bold" :class="checkoutType === 'temp' ? 'text-orange-600 dark:text-orange-400' : 'text-green-600 dark:text-green-400'">
                                {{ checkoutType === 'temp' ? 'Going out for a bit? Use this to re-enter later.' : 'Finished your visit? Use this for final checkout.' }}
                            </p>
                        </div>

                        <div v-if="visit.status === 'Temporarily Out'" class="mb-6 p-4 bg-orange-50 dark:bg-orange-950/30 border border-orange-200 dark:border-orange-900/30 rounded-2xl text-center w-full max-w-xs">
                            <span class="text-2xl block mb-1">🏃</span>
                            <h4 class="text-sm font-black text-orange-950 dark:text-orange-400 uppercase tracking-widest">Temporarily Out</h4>
                            <p class="text-[10px] text-orange-700 dark:text-orange-300 font-bold mt-0.5 leading-relaxed">
                                You have checked out temporarily. Present this QR code at the gate to re-enter.
                            </p>
                        </div>

                        <div class="bg-white dark:bg-gray-800 p-4 border-2 border-gray-200 dark:border-gray-700 rounded-lg shadow-lg dark:shadow-indigo-950/20">
                        ...
                        <div v-if="visit.parking_lot_number" class="mt-6 w-full">
                            <div class="border-t border-gray-100 dark:border-gray-800 pt-6">
                                <button
                                    ...
                                    :class="showMap ? 'bg-indigo-600 dark:bg-indigo-700 border-indigo-600 dark:border-indigo-700 text-white shadow-lg shadow-indigo-100 dark:shadow-indigo-950/30' : 'bg-indigo-50 dark:bg-indigo-950/30 border-indigo-200 dark:border-indigo-900/30 text-indigo-700 dark:text-indigo-400 hover:bg-indigo-100 dark:hover:bg-indigo-950/50'"
                                >
                                ...
                                <div v-if="showMap" class="mt-4 bg-gray-50 dark:bg-gray-800 rounded-2xl p-4 border border-gray-100 dark:border-gray-700">
                ...
                <div class="mt-6 bg-blue-50 dark:bg-blue-950/30 border border-blue-200 dark:border-blue-900/30 rounded-lg p-4">
                    <div class="flex">
                        <div class="flex-shrink-0">
                            <span class="text-blue-400">ℹ️</span>
                        </div>
                        <div class="ml-3">
                            <h3 class="text-sm font-medium text-blue-800 dark:text-blue-400">Visitor Instructions</h3>
