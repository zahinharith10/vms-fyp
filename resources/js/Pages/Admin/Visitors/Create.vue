...
const submit = () => {
    if (!confirm('Are you sure you want to register this visitor?')) return;
    form.post(route('admin.visitors.store'));
};
...
<template>
    ...
    <AuthenticatedLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Register Visitor</h2>
        </template>
